...
| **LOT** | "어떤 것인가?" - 실물 인스턴스 추적 | LOT식별: 251218000001, 251218010001 |
...
**LOT 번호 생성 규칙** (12자리 숫자):
- 포맷: `YYMMDD` + `PP` (공정순서) + `SSSS` (일련번호)
- 원자재 입고(00): `231211000001`
- 샤링 생산(01): `231211010001`
- 프레스 생산(02): `231211020001`
- 조립 생산(03): `231211030001`
